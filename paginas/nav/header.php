<!-- ======= Header ======= -->
  <header id="header" class="header fixed-top d-flex align-items-center">
    ...
    <div class="d-flex align-items-center justify-content-between">
      <a href="../vistas/panel.php" class="logo d-flex align-items-center">
        <img src="../../assets/img/logo-hosanna.png" alt="">
          ...
          <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow profile">
            ...
            <li>
              <a class="dropdown-item d-flex align-items-center" href="users-profile.html">
                ...
                <span>Configuraciones de la Cuentas</span>
              </a>
            </li>
            <li>
              <hr class="dropdown-divider">
            ...
            <li>
              <a class="dropdown-item d-flex align-items-center" href="../../sesiones/close.php">
